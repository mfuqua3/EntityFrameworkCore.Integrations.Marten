...
{
    public MartenIntegrationAnnotationProvider(RelationalAnnotationProviderDependencies dependencies) : base(dependencies)
    {
    }
    ...
    public override IEnumerable<IAnnotation> For(ITableIndex index, bool designTime)
    {
        ...
        return modelIndex.IsMartenComputedIndex()
            ? GetComputedIndexAnnotations(modelIndex).Concat(base.For(index, designTime))
            : base.For(index, designTime);
    }
